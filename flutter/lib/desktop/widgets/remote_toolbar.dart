...
class _ToolbarTheme {
  ...
  static const Color redColor = Colors.redAccent; //COLORWARNING IN TOOLBARTHEME
  ...
  static final defaultMenuButtonStyle = ButtonStyle(
    backgroundColor: MaterialStatePropertyAll(Colors.transparent), //COLORWARNING WHEN IN TOOLBARTHEME
...
class _RemoteToolbarState extends State<RemoteToolbar> {
  ...
  Widget _buildToolbar(BuildContext context) {
    // @escra , starting recording while building the toolbar at the beginning. 
 ...
 //     toolbarItems.add(_VoiceCallMenu(id: widget.id, ffi: widget.ffi));
    // }
//    if (!isWeb) toolbarItems.add(_RecordMenu()); // UICHANGE
...
class _KeyboardMenu extends StatelessWidget {
  ...
  keyboardMode() {
    return futureBuilder(future: () async {
      ...
      // UICHANGES ESCRA view only, then disable
      final enabled = !ffi.ffiModel.viewOnly;
