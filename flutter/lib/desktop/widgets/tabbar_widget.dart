...
CancelFunc showRightMenu(ToastBuilder builder,
  ...
  return BotToast.showAttachedWidget(
    ...
    allowClick: true,
    enableSafeArea: true,
    backgroundColor: Color(0x00000000), //COLORWARNING WHEN showing right menu // HARDCODEDCOLOR
...
class DesktopTab extends StatefulWidget {
  ...
  DesktopTab({
    ...
    this.showLogo = true,
    this.showTitle = true, // change here if you want to show title
    ...
    return CustomAlertDialog(
      title: Row(children: [
        const Icon(Icons.warning_amber_sharp,
            color: Colors.redAccent, size: 28), //COLORWARNING WHEN showing dialog
    ...
    return Tooltip(
      ...
      child: InkWell(
        hoverColor: widget.isClose
            ? const Color.fromARGB(255, 196, 43, 28) //COLORWARNING WHEN showing action icon?
...
class TabbarTheme extends ThemeExtension<TabbarTheme> {
  ...
  static const light = TabbarTheme(
      ...
      unSelectedTabIconColor: MyTheme.accent2,
  ...
  static const dark = TabbarTheme(
      selectedTabIconColor: MyTheme.accent,
      unSelectedTabIconColor: MyTheme.accent2, // Color.fromARGB(255, 30, 65, 98),
