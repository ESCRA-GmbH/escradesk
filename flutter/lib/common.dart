...
class MyTheme {
  ...
  */
  /// ------------------------------------------------
  /// CHANGe: A new set of colors for the theme
  static const Color grayBg = Color(0xFF2ce014);
  static const Color white = Color(0xFF2ce014);
  static const Color accent = Color(0xFFa50050);
  static const Color accent2 = Color.fromARGB(255, 133, 45, 45); // Color.fromARGB(255, 117, 0, 57);
  static const Color accent50 = Color(0xFF2ce014);
  static const Color accent80 = Color(0xFF2ce014);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFFD7026B);
  static const Color darkGray = Color(0xFFB9BABC);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFFC70261);
  static const Color hoverBorder = Color(0xFF999999);
  ...
  /// CHANGE: Defining a color scheme
  static final lightColorScheme = ColorScheme(
    ...
    surfaceTint: Color(0xFFB5175C),
    outlineVariant: Color(0xFFB9BABC),
    scrim: Color(0xFF000000),
  );


  /// CHANGE: Declaring a new color scheme
  static final darkColorScheme = ColorScheme(
    ...
    inversePrimary: Color(0xFFB5175C),
    shadow: Color(0xFF000000),
  ...
  /// WARNING: // Theme.of(context).primaryColor
  // Dieser Ausdruck ist dann nicht mehr const
  ...
  */
  ...
  /// CHANGE: lightTheme and darkTheme are defined again
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    buttonTheme: ButtonThemeData(buttonColor: lightColorScheme.secondary)
  );
  static ThemeData darkTheme = ThemeData(
...
/// WARNING: window on top funcions are a bit different then normal file, hope thats fine
  ...
  Future<T?> show<T>(DialogBuilder builder,
    ...
    dialog.entry = OverlayEntry(builder: (context) {
      ...
      return Listener(
          ...
          child: Container(
              color: Theme.of(context).brightness == Brightness.light //COLORWARNING WHEN SHOWING DIALOG
                  ? Colors.black12 // HARDCODEDCOLOR
                  : Colors.black45,
        ...
        child: Align(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: Colors.black.withOpacity(0.6), // HARDCODEDCOLOR //COLORWARNING WHEN showing a toast??
              ...
              child: Text(
                ...
                style: TextStyle(
                    ...
                    fontSize: 18,
                    color: Colors.white), // HARDCODEDCOLOR //COLORWARNING WHEN having a child for pointer in a text
              ),
            )));
  });
...
void msgBox(SessionID sessionId, String type, String title, String text,
  ...
  dialogManager.show(
    (setState, close, context) => CustomAlertDialog(
      title: null, // SHOULD LOOK HERE LATER
...
Color? _msgboxColor(String type) {
  if (type == "input-password" || type == "custom-os-password") {
    return Color(0xFFAD448E); //COLORWARNING WHEN we give a color to the msgbox.
  }
  ...
  // @escra dialog shown icon color change. 
...
//COLORWARNING WHEN str2color2 might be used...
...
// @escra a helper function to configure options...
bool checkForConditions(bool value, String key){
  var res = bind.mainGetOptionSync(key: key);

  if (value){
    // if the default true, we change something if we have No value from the toml
    return res != "N";
  }
  else {
    // if the default false, we change something if we have Yes value from the toml
    return res == "Y";
  }
}
...
Future<bool> initUniLinks() async {
  ...
  // WILL CHANGE HERE // SHOULD LOOK HERE // CHECK LATER ON -- register protocal if windows... // LOGIC MERGE CHANGE
  // check cold boot
  try {
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing EscraDesk..."); // CHANGED HERE BRANDING
...
Widget unreadMessageCountBuilder(RxInt? count,
  ...
  return Obx(() => Offstage(
      ...
      child: Container(
        ...
        height: size ?? 16,
        decoration: BoxDecoration(
          color: Colors.red, // HARDCODEDCOLOR //COLORWARNING WHEN we use unreadmessage count
          shape: BoxShape.circle,
        ),
        child: Center(
          child: Text("${count?.value ?? 0}",
              maxLines: 1,
              style: TextStyle(color: Colors.white, fontSize: fontSize ?? 10)), // HARDCODEDCOLOR //COLORWARNING WHEN we use unreadmessage count
        ),
      )));
}
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://escra.de'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
