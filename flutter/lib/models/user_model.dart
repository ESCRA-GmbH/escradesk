...
class UserModel {
  ...
  Future<LoginResponse> login(LoginRequest loginRequest) async {
    final url = await bind.mainGetApiServer(); // LOGIC MERGE CHANGE // MERGE CHANGE // WILL LOOK HERE // SHOULD LOOK HERE
    ...
    try {
      ...
      if (resp.statusCode != 200) {
        BotToast.showText(
            contentColor: Colors.red, text: 'HTTP ${resp.statusCode}'); //COLORWARNING WHEN Toastshowing...
      }
      rethrow;
    }
    if (resp.statusCode != 200) {
