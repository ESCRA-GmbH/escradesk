...
class PeerTabModel with ChangeNotifier {
  ...
  static bool getOption(String key) {
  ...
  List<bool> isEnabled = List.from([
    true && !getOption(kOptionHideRecentPeersView),
    true && !getOption(kOptionHideFavoritePeersView),
    !isWeb && !getOption(kOptionHideDiscoverPeersView) && bind.mainGetLocalOption(key: "disable-discovery-panel") != "Y",
    false || getOption(kOptionShowAddressBookPeersView), // !(bind.isDisableAb() || bind.isDisableAccount()),
    false || getOption(kOptionShowMyGroupPeersView), // !(bind.isDisableGroupPanel() || bind.isDisableAccount()),
  ]);
