...
Future<void> main(List<String> args) async {
  ...
  // @escra , setting the window fullscreen
  // tried to do that by the code below but it didnt work...
  // debugPrint("well here is fullscreen");
  // WindowController.fromWindowId(kWindowId!).setFullscreen(true);
  ...
  if (args.isNotEmpty && args.first == 'multi_window') {
  ...
  } else if (args.contains('--uninstallpage')) {
    // @escra calling the uninstall page
    debugPrint("Uninstall called");
    runUninstallPage();
  } else if (args.contains('--install')) {
    debugPrint("Install called");
    runInstallPage();
  } else {
    ...
    if (isMacOS) {
      ...
      // @escra , making the window fullscreen
...
void runMainApp(bool startService) async {
  ...
  // Escradesk does not check for updates.
  // checkUpdate();
  ...
  windowManager.waitUntilReadyToShow(windowOptions, () async {
    ...
    // Set fullscreen here to make it fullscreen in linux 
...
void _runApp(
  ...
  runApp(RefreshWrapper(
    builder: (context) => GetMaterialApp(
      ...
      title: title,
      theme: MyTheme.lightTheme, //COLORWARNING WHEN we use theme attribute
...
void runUninstallPage() async {
  await windowManager.ensureInitialized();
  await initEnv(kAppTypeMain);
  _runApp('', const UninstallPage(), MyTheme.currentThemeMode());
    ...
    return RefreshWrapper(builder: (context) {
      return MultiProvider(
        ...
        child: GetMaterialApp(
          navigatorKey: globalKey,
          debugShowCheckedModeBanner: false,
          title: 'EscraDesk',  //BRANDING // CHANGE : naming here
