...
const String kOptionHideDisplaySetting = "hide-display-settings";
const String kOptionHideAudioSetting = "hide-audio-settings";

///// escradesk added options @escra
const String kOptionHideGeneralSettingTab = "hide-general-setting-tab";
const String kOptionHideSafetySettingTab = "hide-safety-setting-tab";
const String kOptionHideNetworkSettingTab = "hide-network-setting-tab";
const String kOptionHideDisplaySettingTab = "hide-display-setting-tab";
const String kOptionShowPluginSettingTab = "show-plugin-setting-tab";
const String kOptionShowAccountSettingTab = "show-account-setting-tab";
const String kOptionHideAboutSettingTab = "hide-about-setting-tab";

const String kOptionHideRecentPeersView = "hide-recent-peers-view";
const String kOptionHideFavoritePeersView = "hide-favorite-peers-view";
const String kOptionHideDiscoverPeersView = "hide-discover-peers-view";
const String kOptionShowAddressBookPeersView = "show-address-book-peers-view";
const String kOptionShowMyGroupPeersView = "show-my-group-peers-view";

const String kOptionShowRemoteCursorInToolbarToggle = "show-remote-cursor-in-toolbar-toggle";
const String kOptionShowZoomCursorInToolbarToggle = "show-zoom-cursor-in-toolbar-toggle";
const String kOptionShowMuteInToolbarToggle = "show-mute-in-toolbar-toggle";
const String kOptionShowCopyPasteInToolbarToggle = "show-copy-paste-in-toolbar-toggle";
const String kOptionShowPrivacyModeInToolbarToggle = "show-privacy-mode-in-toolbar-toggle";

///////////////////////////////////// finished added options
...
const String kUniLinksPrefix = "escradesk://";
const String kUrlActionClose = "close";

/* CHANGE: changing unilinks prefix but not applied
const String kUniLinksPrefix = "escradesk://";
...
const String kEnvPortableExecutable = "ESCRADESK_APPNAME"; // MERGE CHANGE // SHOULD LOOK HERE
