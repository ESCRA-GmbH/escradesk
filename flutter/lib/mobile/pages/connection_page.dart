...
class _ConnectionPageState extends State<ConnectionPage> {
  ...
  Widget _buildUpdateUI(String updateUrl) {
    return updateUrl.isEmpty
        ...
        : InkWell(
            onTap: () async {
              final url = 'https://www.escra.de/download';  // WILL CHANGE HERE - simple hardcooding
            ...
            child: Container(
                ...
                color: Colors.pinkAccent, // HARDCODEDCOLOR
                padding: const EdgeInsets.symmetric(vertical: 12),
                child: Text(translate('Download new version'), // WILL CHANGE HERE - simple hardcoding
