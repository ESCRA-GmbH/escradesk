                ...
                row(
                    label: Row(
                      children: [
                        Text(
                          '*',
                          style: TextStyle(color: Colors.red, fontSize: 14), // HARDCODEDCOLOR
                        ),
                        Text(
                          'ID',
                          style: style,
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(isUnTagged ? translate(name) : name,
                        style: TextStyle(
                            overflow: TextOverflow.ellipsis,
                            color: tags.contains(name) ? Colors.white : null)), // HARDCODEDCOLOR
                  ),
                ],
              ),
            ),
    ...
    final items = [
      ...
      getEntry(translate(translate('Change Color')), () async {
        ...
        Color newColor = await showColorPickerDialog(
          ...
          pickerTypeLabels: {
            ColorPickerType.primary: translate("Primary Color"), // HARDCODEDCOLOR
            ColorPickerType.wheel: translate("HSV Color"), // HARDCODEDCOLOR
          },
    ...
    mod_menu.showMenu(
      ...
      items: items
          .map((e) => e.build(
              context,
              MenuConfig(
                  commonColor: CustomPopupMenuTheme.commonColor, // HARDCODEDCOLOR
                  height: CustomPopupMenuTheme.height,
                  dividerHeight: CustomPopupMenuTheme.dividerHeight)))
          .expand((i) => i)
          .toList(),
