                                    ...
                                    child: Tooltip(
                                      ...
                                      child: Text(
                                        ...
                                        style: const TextStyle(
                                            color: Colors.white70, // HARDCODEDCOLOR
                                            fontSize: 12),
    ...
    return MenuEntryButton<String>(
      childBuilder: (TextStyle? style) => Row(
        children: [
          Text(
            translate('Delete'),
            style: style?.copyWith(color: Colors.red), // HARDCODEDCOLOR
          ),
          Expanded(
              child: Align(
            alignment: Alignment.centerRight,
...
class RecentPeerCard extends BasePeerCard {
  ...
  Future<List<MenuEntryBase<String>>> _buildMenuItems(
    ...
    final List<MenuEntryBase<String>> menuItems = [
      ...
      // @escra removing transferfileaction thing..
    ...
    // @escra tcp tunellung is also removed here
