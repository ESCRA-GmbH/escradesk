...
// It creates the default services it is going to use. And starts the server. 
...
pub async fn start_server(is_server: bool, no_server: bool) {
    ...
    // We would like it to start servers as it starts to the program.
    // But if we put the function here, the was not starting, it should been async. 
    // Now it is called from core-main 
    // crate::send_videos_to_server();
