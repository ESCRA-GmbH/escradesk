...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Webseite"),
        ("About", "Über"),
        ("Slogan_tip", "ESCRA - simply secure - sec4all!"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann EscraDesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren EscraDesk auf dem System."),
        ("Click to upgrade", "Zum Upgraden klicken"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie EscraDesk Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie EscraDesk die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie EscraDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"EscraDesk Input\" ein."),
        ...
        ("Quit", "Beenden"),
        ("doc_mac_permission", "https://www.escra.de"),
        ("Help", "Hilfe"),
        ...
        ("Language", "Sprache"),
        ("Keep RustDesk background service", "EscraDesk im Hintergrund ausführen"),
        ...
        ("Show RustDesk", "EscraDesk anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie EscraDesk die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie EscraDesk die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von EscraDesk auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "EscraDesk-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein EscraDesk-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um EscraDesk-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_rustdesk_password_tip", "EscraDesk-Passwort bestätigen"),
        ...
        ("HSV Color", "HSV-Farbe"),
        // adding new translations ... @escra
        ("clear_user_data", "Benutzerdaten reinigen"),
        ...
        ("powered_by_me", "Unterstützt von EscraDesk"),
