...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the EscraDesk network..."),
        ...
        ("install_tip", "Due to UAC, EscraDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install EscraDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant EscraDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant EscraDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow EscraDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [EscraDesk Input] service."),
        ...
        ("doc_fix_wayland", "https://www.escra.de"),
        ("server_not_support", "Not yet supported by the server"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next EscraDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant EscraDesk \"Input Monitoring\" permissions."),
        ...
        ("install_cert_tip", "Install EscraDesk certificate"),
        ("confirm_install_cert_tip", "This is a EscraDesk testing certificate, which can be trusted. The certificate will be used to trust and install EscraDesk drivers when required."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter EscraDesk password"),
        ("remember_rustdesk_passwd_tip", "Remember EscraDesk password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify EscraDesk password"),
        ...
        ("powered_by_me", "Powered by EscraDesk"),
