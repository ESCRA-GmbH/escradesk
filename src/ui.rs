...
pub fn start(args: &mut [String]) {
    ...
    if args.is_empty() {
        ...
        // remove software update checking 
...
pub fn get_icon() -> String {
    ...
    { // change here
        ...
        "data:image/png;base64,".into()
    }
}
